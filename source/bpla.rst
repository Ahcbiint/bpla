...
Планировщик миссий БПЛА – это автономный модуль, который встраивается в программные продукты, разработанные на базе платформы автоматизации `«CITORUS» <https://citorus.ru/decisions/pa-citorus/="">`_ (в частности – в систему «Кедр»). Модуль предназначен для формирования миссий беспилотных летательных аппаратов (далее – *БПЛА*) с целью их дальнейшей загрузки в БПЛА. Пользователями модуля являются выездные рейдовые группы управления лесами в `Приморском крае <https://citorus.ru/news/26/="">`_.
...
Чтобы создать миссию, в `системе «Кедр» <https://citorus.ru/kedr/>`_, в меню быстрого доступа к функциональности нажмите на кнопку **Карта** (рис. 7).
...
Чтобы импортировать миссию, разверните панель планировщика миссий нажатием на кнопку |image4| **Планировщик миссий БПЛА** (рис. 65, цифра 1).
...
Если требуется полностью удалить конфигурацию созданной миссии, сверните панель планировщика миссий нажатием на кнопку |image4| **Планировщик миссий БПЛА** (рис. 67).
...
.. _Управление геокодированными объектами. Универсальная геокатегория: http://docs.citorus.ru/docs/citorus/ru/latest/model.html#managing-geo-objects
.. _Поиск объектов системы: http://docs.citorus.ru/docs/citorus/ru/latest/obj.html#id61
